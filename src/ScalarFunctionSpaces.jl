...
# ScalarFunctionSpace
struct SFSFaceData{dim,fdim,T,comps}
    L::Array{T,3}
    E :: Matrix{Vector{T}}
    detJf::Matrix{T}
...
struct PSFSFaceData{dim,fdim,T,comps}
    L::Array{T,3}
    E :: Matrix{Vector{T}}
    detJf::Array{T,3}
...
function _sface_data(::Type{T}, mesh::PolygonalMesh{dim,N1,N2,N3,T}, quad_degree::Int,
    ...
    PSFSFaceData{dim,fdim,T,1}(L, E, detJf, normals, q_ref_faceweights, q_ref_facepoints)
end
...
function _sface_data(::Type{T}, mesh::PolygonalMesh{dim,N1,N2,N3,T}, quad_degree::Int,
    ...
    SFSFaceData{dim,fdim,T,1}(L, E, detJf, normals, q_ref_faceweights, q_ref_facepoints)
end
